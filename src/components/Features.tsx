...
const BentoTilt: React.FC<BentoTiltProps> = ({ children, className = "" }) => {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const relativeX: number = (e.clientX - left) / width;
    const relativeY: number = (e.clientY - top) / height;
    ...
    <section className="bg-black pb-52 ">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p className="font-cir-web text-lg text-blue-50">
            Into the Metagame Layer
          </p>
          <p className="max-w-md font-cir-web text-lg text-blue-50 opacity-50">
